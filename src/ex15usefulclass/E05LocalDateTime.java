...
public class E05LocalDateTime {
	...
	public static void main(String[] args) {
		...
		DateTimeFormatter format4=DateTimeFormatter.ofPattern("오늘은 M월의 W번째주, d번째날,F번째E요일");
		...
		//?일 남음
		System.out.println(ChronoUnit.DAYS.between(localDateTime, xMas)+"개월 남음");
		//어제와 오늘
